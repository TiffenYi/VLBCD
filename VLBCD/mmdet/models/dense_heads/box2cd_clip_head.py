...
class Box2cd_CLIP_Head(BaseModule):
    def __init__(self,
                 num_classes,
                 in_channels,
                 ...
                 type_dcn=None,
                 init_cfg=None):
        super(Box2cd_CLIP_Head, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        super(Box2cd_CLIP_Head, self).init_weights()
    ...
    def loss(self,
        ...
        loss_similarity=self.loss_similarity(x1,x2,score_map1,score_map2,mask_and_score_list)
        ...
        for not_ins_pred  in not_ins_preds:
            ...
            loss_not_ins+=self.loss_not_ins_weight[0]*mask_pred.mean()  #求均值是否不如求和？
