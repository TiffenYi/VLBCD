...
class BoxSOLOv2Head_v2(BaseModule):
    def __init__(self,
                 num_classes,
                 in_channels,
                 ...
                 type_dcn=None,
                 init_cfg=None):
        super(BoxSOLOv2Head_v2, self).__init__(init_cfg=init_cfg)
    ...
    def _init_layers(self):
        ...
        # self.sscr_cam=nn.Sequential(
        #     nn.Conv2d(self.seg_feat_channels, 2, kernel_size=1, stride=1),
    ...
    def init_weights(self):
        super(BoxSOLOv2Head_v2, self).init_weights()
        ...
        # normal_init(self.sscr_cam, std=0.01)
    ...
    def forward(self, feats, eval=False):
        ...
        #得到的kernel_pred和cate_pred是根据不同层级的fpn输入进行的
    ...
    def loss(self,
        ...
        # print('gt_bbox_list_'*5)
        # print(len(gt_bbox_list))
        # print(gt_bbox_list[0].size())
        # print('ins_label_'*5)
        # for item in ins_labels:
        #     print(item.size())
        #     print(item[0])
